...
subject = '{} Locallibrary email confirmation'.format
message = 'Please confirm your email below "{}"'.format
...
# to one user.
try:
    send_mail(subject, message, 'minhvuvlbay@gmail.com', [user_email])
    send = True
except:
